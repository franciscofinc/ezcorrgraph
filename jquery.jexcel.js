    ...
    createTable : function() {
        ...
        if (! $('.jexcel_corner').length) {
            ...
            $(document).on("contextmenu", function (e) {
                nome = $.fn.jexcel.selectedHeader[0];
                console.log(nome);
                        ...
                        if (o) {
                            ...
                            if (typeof(options.contextMenu) == 'function') {
                                ...
                                if ($(e.target).parent().parent().is('thead')) {
                                    contextMenuContent += "<a onclick='var favDrink = prompt(\"Nome da coluna:\");switch(favDrink){case null:break;case \"\":break;default:nome.title = favDrink;nome.textContent = favDrink;}'>Alterar nome da coluna<span></span></a>";
                                    contextMenuContent += "<a onclick=\"$('#" + $.fn.jexcel.current + "').jexcel('orderBy', " + o[1] + ", 0)\">Ordenar crescente <span></span></a>";
                                    contextMenuContent += "<a onclick=\"$('#" + $.fn.jexcel.current + "').jexcel('orderBy', " + o[1] + ", 1)\">Ordenar decrescente <span></span></a><hr>";
                                    if ($.fn.jexcel.defaults[$.fn.jexcel.current].allowInsertColumn == true) {
                                        contextMenuContent += "<a onclick=\"$('#" + $.fn.jexcel.current + "').jexcel('insertColumn', 1, null, " + o[1] + ")\">Inserir nova coluna<span></span></a>";
                                    }
                                    if ($.fn.jexcel.defaults[$.fn.jexcel.current].allowInsertRow == true) {
                                        contextMenuContent += "<a onclick=\"$('#" + $.fn.jexcel.current + "').jexcel('insertRow', 1, " + o[1] + ")\">Inserir nova linha<span></span></a><hr>";
                                    }
                                    if ($.fn.jexcel.defaults[$.fn.jexcel.current].allowDeleteColumn == true) {
                                        contextMenuContent += "<a onclick=\"$('#" + $.fn.jexcel.current + "').jexcel('deleteColumn'," + o[1] + ")\">Remover esta coluna<span></span></a><hr>";
                                    }
                                    contextMenuContent += "<a onclick=\"$('#" + $.fn.jexcel.current + "').jexcel('download')\">Exportar CSV<span>Ctrl + S</span></a>";
                                    if (options.about) {
                                        contextMenuContent += "<a onclick=\"alert('" + options.about + "')\">Sobre<span></span></a>";
                                    }
                                    ...
                                    if ($.fn.jexcel.defaults[$.fn.jexcel.current].allowDeleteRow == true) {
                                        contextMenuContent += "<a onclick=\"$('#" + $.fn.jexcel.current + "').jexcel('deleteRow'," + o[1] + ")\">Remover esta linha<span></span></a><hr>";
                                    }
                                    contextMenuContent += "<a onclick=\"$('#" + $.fn.jexcel.current + "').jexcel('download')\">Exportar CSV<span>Ctrl + S</span></a>";
                                    if (options.about) {
                                        contextMenuContent += "<a onclick=\"alert('" + options.about + "')\">Sobre<span></span></a>";
